...
package com.monadiccloud.bindingz.contract.plugin.maven.providers;
...
public class JsonSchema2PojoConfiguration implements GenerationConfig {
    ...
    public JsonSchema2PojoConfiguration(File targetSourceDirectory, File targetResourceDirectory, String providerName, String contractName, String version, String packageName, String className) {
    ...
    public void setTargetLangauge(String language) {
        targetLanguage = org.jsonschema2pojo.Language.valueOf(language.toUpperCase());
    }
